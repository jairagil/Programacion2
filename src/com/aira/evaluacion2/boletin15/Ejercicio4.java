...
public class Ejercicio4 {
	...
	public static void main(String[] args) {
		...
		System.out.println("Introduce los 8 digitos del DNI:");

		try	{
			System.out.printf("La letra correspondiente es %s", comprobarDNI(scanner.nextLine()));
	...
	static String generarDNI() {
		...
		for (int i = 0; i < 8; i++) {
			DNI += Ejercicio1.generarNumero(10);
		}
